...
"background-color:transparent;\ncolor:white;")
        ...
        self.lineEdit.setGeometry(QtCore.QRect(50, 800, 400, 40))
        self.lineEdit.setStyleSheet("font: 14pt \"MS Shell Dlg 2\";\n"
"background-color: rgba(255, 255, 255, 200);\n"
"border: 2px solid #0099ff;\n"
"border-radius: 10px;\n"
"padding: 5px;")
        self.lineEdit.setPlaceholderText("Type your command here...")
        self.lineEdit.setObjectName("lineEdit")
        
        # Add send button
        self.sendButton = QtWidgets.QPushButton(self.centralwidget)
        self.sendButton.setGeometry(QtCore.QRect(470, 800, 80, 40))
